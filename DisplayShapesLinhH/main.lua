...
-- Drawing my Heptagon
local myHeptagon = display.newPolygon(750, 600, verticesS)

-- Set the colour of the Heptagon
myHeptagon:setStrokeColor(1,1,1)

-- Set the width of the border
myHeptagon.strokeWidth = 6

-- Set the colour of the border
myHeptagon:setFillColor(1, 0.5 , 0)

-- Display the name of the shape below it
heptagonText = display.newText("Heptagon", 750, 730, Arial, 40)

-- Set text colour
heptagonText:setTextColor(253/255, 106/255, 2/255)
